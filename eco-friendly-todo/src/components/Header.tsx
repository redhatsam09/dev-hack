        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          {user && (
            <>
              ...
              <Link href="/leaderboard" className="text-gray-600 hover:text-[#b4d093] transition-colors font-medium flex items-center">
        ...
        <div className="relative">
          {loading ? (
            ...
            <div className="flex items-center gap-4">
              ...
              {menuOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-lg shadow-xl z-20 border border-gray-200">
                  <div className="py-2">
                    <div className="px-4 py-2 border-b border-gray-100">
                      <p className="text-sm text-gray-500">Signed in as</p>
                      <p className="text-sm font-medium text-gray-800 truncate">{user.email}</p>
                    </div>
                    <Link href="/web-app" className="block px-4 py-3 text-gray-800 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center">
